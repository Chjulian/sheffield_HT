#################################################################################
#This script combines each individual outbreaker run into 3 files
# 1. outcomes.rds - analysis of outbreaker runs
# 2. res-combined.rds - the raw results of each outbreaker MCMC run
# 3. steps-combined.rds - each MCMC step with metadata adding in
#################################################################################
