...
## timed contact data
get_initial_tree <- function(data, config, n_iter = 5e3) {
  ...
  tmp_config[c("move_kappa", "move_alpha", "find_import", "move_tau", "move_model",
               "move_joint", "swap_place")] <- FALSE
  tmp_config$move_joint <- TRUE
